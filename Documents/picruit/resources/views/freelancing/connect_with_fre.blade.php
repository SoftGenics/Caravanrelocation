            ...
            <div class="mask d-flex align-items-center" style=" min-height:100vh">
                <div class="container-fluid mt-5">
                    ...
                    <div class="text-center my-5">
                        <h1 class="fw-bolder">Welcome to Connect!</h1>
                        <p class="lead mb-0">Picuit Freelancer </p>
                    </div>
                    <!-- searching form-->
                    ...
                    <div id="show-hide-form">
                        <form class="row form-group mr-3" action="" style="background-color: #999999; padding:10px">
                            ...
                            <div class="col-2">
                                <input type="search" class="form-control" name="state" id=""
                                    aria-describedby="helpId" placeholder="Enter your state">
                            </div>
