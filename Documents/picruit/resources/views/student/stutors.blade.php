      ...
      <div class="col-6">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 d-flex align-items-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Save tutors</li>
          </ol>
        </nav>
        <h1 class="mb-0 fw-bold">Save tutors</h1>
      </div>
                                ...
                                <table class="table">
                                    <thead style="background:#198754;">
                                        <tr>
                                            ...
                                            <th scope="col" style="color:#fff;">Qualification</th>
                                    ...
                                    <!--msg box-->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $item->city}}</td>
                                                <td>{{ $item->gender}}</td>
                                                 <td>{{App\Models\Qualification::where('user_id', $item->user_id)->first()->Stream}}</td>
