      ...
      <div class="col-6">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 d-flex align-items-center">
            ...
            <li class="breadcrumb-item active" aria-current="page">Recent Checked tutors</li>
          </ol>
        </nav>
        <h1 class="mb-0 fw-bold">Recent Checked tutors</h1>
      </div>
                                ...
                                <table class="table">
                                    <thead style="background:#198754;">
                                        <tr>
                                            ...
                                            <th scope="col" style="color:#fff;">Rating</th>
