                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="psname" placeholder="if a student, your parent's name or vice versa"
                                                class="form-control form-control-line"  value="{{$user?$user['psname']:"Empty"}}">
                                        </div>
                                    </div>
                                    {{-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-select shadow-none form-control-line" name="country" >
                                                <option>{{$user?$user['country']:"Choose Your Option"}}</option>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#state').val(data[0]['State']);
                     $("#validation").text("Correct Pincode").css("color","green")
                    }
                    else{
                        $("#validation").text("Invalid Pincode").css("color","red");
                    }
                }
            });
