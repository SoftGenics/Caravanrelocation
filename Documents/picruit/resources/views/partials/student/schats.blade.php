...
@endphp
                            <div class="list-group lg-alt">
                                ...
                                <a class="list-group-item media" href="javascript:chatwith({{$userz[$disp1]}})" id="{{$userz[$disp1]}}">
                                    
                                    <div class="pull-left">
                                        @php
                                        $useri=\App\Models\Profile_pics::where("user_id",$userz[$disp1])->first();
                                        @endphp
                                        <img src="{{$useri['image']}}" alt="" class="img-avatar" id="im{{$userz[$disp1]}}">
                                       
                                    </div>
                                    <div class="media-body">
                                        <small class="list-group-item-heading"> &nbsp {{$userz[$cv]}}</small>
       ...
       var data = {
                     ...
                     $.ajax({
                                ...
                                success: function(result)
                                {
                                 ...
                                 for (var j = 0; j< len; j++) {
                                    if(result[j]["type"]=="s")
                                    {
                                        $("#chatplay").append(' <div class="message-feed right"><div class="pull-right"><img src="'+result[j]["img"]+'" alt="" class="img-avatar"></div><div class="media-body"><div class="mf-content">'+result[j]["message"]+'</div><small class="mf-date"><i class="fa fa-clock-o"></i>'+result[j]["Date"]+'</small></div></div>');
                                    }
                                    else
                                    {
                                        $("#chatplay").append(' <div class="message-feed media"><div class="pull-left"><img src="'+result[j]["img"]+'" alt="" class="img-avatar"></div><div class="media-body"><div class="mf-content">'+result[j]["message"]+'</div><small class="mf-date"><i class="fa fa-clock-o"></i> '+result[j]["Date"]+'</small></div></div>');
                                    }
                                 }
                     ...
                     $.ajax({
                                ...
                                success: function(result)
                                {
                                 ...
                                 if(len!=0)
                                 {
                                 $("#chatplay").append(' <div class="message-feed media"><div class="pull-left"><img src="'+result[0]["img"]+'" alt="" class="img-avatar"></div><div class="media-body"><div class="mf-content">'+result[0]["message"]+'</div><small class="mf-date"><i class="fa fa-clock-o"></i> '+result[0]["Date"]+'</small></div></div>');
...
// console.log(todayDate);
                                $("#chatplay").append(' <div class="message-feed right"><div class="pull-right"><img src="{{$imgus}}" alt="" class="img-avatar"></div><div class="media-body"><div class="mf-content">'+mk+'</div><small class="mf-date"><i class="fa fa-clock-o"></i>'+td+'</small></div></div>');
                                //$("#msg").val()="";
