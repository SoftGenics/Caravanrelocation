@extends ('layouts.app')
@section('content')
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/css/bootstrap.min.css" rel="canonical" 
...
@section('content')
    <header class="py-5 bg-light border-bottom mb-4 fo" style="margin-top: 123px;">
        <div class="container">
            @include('pages.ad_blog')
            
            <div class="text-center mt-2 my-5">
                <h1 class="fw-bolder">Welcome to  News!</h1>
                <p class="lead mb-0">Pircuit News</p>
                                    ...
                                    @foreach (\App\Models\Blog::all()->sortByDesc as $tp)
                                        @if ($tp['status'] == '1' && $k <= 3)
                                            ...
                                            <div class="post-item clearfix mb-3">
                                                ...
                                                <br>
                                                <a href="{{ url('blog/single/' . $tp['id']) }}">{{ $tp['title'] }}</a>
                                                <br>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            ...
                                            <br /> <br /> <br />
                                            <div class="form-group">
                                                <label for="exampleFormControlbody1">News Body</label>
    ...
    <script>
        $(document).ready(() => {
            ...
            $("#blogupload").click(function() {
                ...
                formData.append('body', markupStr);
                $.ajax({
                    cache: false,
                    contentType: false,
                    processData: false,
