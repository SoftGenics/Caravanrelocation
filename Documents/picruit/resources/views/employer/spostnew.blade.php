                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <form class="" action="{{route('New-post-job')}}" method="post">
                          ...
                          <div class="form-floating mb-3">
                            <input type="number" class="form-control border border-info" placeholder="" name="minsalary">
                            ...
                            </svg>&nbsp<span class="border-start border-info ps-3">Monthly salary minimum</span></label>
                          </div>
                           <div class="form-floating mb-3">
                            <input type="number" class="form-control border border-info" placeholder="" name="maxsalary">
                            <label><svg xmlns="http://www.w3.org/2000/svg" style="color:#7bc5fd;" width="24" height="24" fill="currentColor" class="bi bi-currency-rupee" viewBox="0 0 16 16">
                              <path d="M4 3.06h2.726c1.22 0 2.12.575 2.325 1.724H4v1.051h5.051C8.855 7.001 8 7.558 6.788 7.558H4v1.317L8.437 14h2.11L6.095 8.884h.855c2.316-.018 3.465-1.476 3.688-3.049H12V4.784h-1.345c-.08-.778-.357-1.335-.793-1.732H12V2H4v1.06Z"/>
                            </svg>&nbsp<span class="border-start border-info ps-3">Monthly salary maximum</span></label>
                          </div>
                          <div class="form-floating mb-3">
                              <input type="date" class="form-control  border border-info" id="stime" name="start_time">
                            ...
                            </svg>&nbsp<span class="border-start border-info ps-3">Start date</span></label>
                          </div>
                          <div class="form-floating mb-3">
                           
                              <input type="date" class="form-control border border-info" id="etime" name="end_time">
                            
                            <label><svg xmlns="http://www.w3.org/2000/svg" style="color:#7bc5fd;" width="24" height="24" fill="currentColor" class="bi bi-alarm" viewBox="0 0 16 16">
                              <path d="M8.5 5.5a.5.5 0 0 0-1 0v3.362l-1.429 2.38a.5.5 0 1 0 .858.515l1.5-2.5A.5.5 0 0 0 8.5 9V5.5z"/>
                              <path d="M6.5 0a.5.5 0 0 0 0 1H7v1.07a7.001 7.001 0 0 0-3.273 12.474l-.602.602a.5.5 0 0 0 .707.708l.746-.746A6.97 6.97 0 0 0 8 16a6.97 6.97 0 0 0 3.422-.892l.746.746a.5.5 0 0 0 .707-.708l-.601-.602A7.001 7.001 0 0 0 9 2.07V1h.5a.5.5 0 0 0 0-1h-3zm1.038 3.018a6.093 6.093 0 0 1 .924 0 6 6 0 1 1-.924 0zM0 3.5c0 .753.333 1.429.86 1.887A8.035 8.035 0 0 1 4.387 1.86 2.5 2.5 0 0 0 0 3.5zM13.5 1c-.753 0-1.429.333-1.887.86a8.035 8.035 0 0 1 3.527 3.527A2.5 2.5 0 0 0 13.5 1z"/>
                            </svg>&nbsp<span class="border-start border-info ps-3">End date</span></label>
                          </div>
                          <div class="form-floating mb-3">
