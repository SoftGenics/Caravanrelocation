            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">Edit new requirements</h1> 
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        ...
                        $id=request('id');
                      $job=App\Models\enewjobs::find($id);
                        @endphp
                        
                        <form class="" action="{{url('EditNewpost')}}/{{$id}}" method="post">
                            @csrf
                          <div class="form-floating mb-3">
                              <input type="hidden" name="user_id" value="{{$user->id}}" />
                            <input type="text" class="form-control border border-info" value="{{$job->title}}"  placeholder="" name="title">
                          ...
                          <div class="form-floating mb-3 ">
                            ...
                            <input type="date" name="date" value="{{$job->date}}" class="form-control  border border-info" id="date">
                          ...
                          <div class="form-floating mb-3">
                            <input type="number" class="form-control border border-info" placeholder="" value="{{$job->salary}}" name="salary">
                          ...
                          <div class="form-floating mb-3">
                              <input type="time" class="form-control  border border-info" id="stime" value="{{$job->start_time}}"  name="start_time">
                          ...
                          <div class="form-floating mb-3">
                              ...
                              <input type="time" class="form-control border border-info" id="etime" value="{{$job->etime}}"  name="end_time">
                          ...
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control border border-info" value="{{$job->job_detail}}" name="job_detail" >
                          ...
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control border border-info" placeholder="" value="{{$job->location}}" name="location">
